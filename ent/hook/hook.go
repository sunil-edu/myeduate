...
// The MstInstFunc type is an adapter to allow the use of ordinary
// function as MstInst mutator.
type MstInstFunc func(context.Context, *ent.MstInstMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f MstInstFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
