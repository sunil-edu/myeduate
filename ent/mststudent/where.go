...
func StdStatusEQ(v customtypes.StdStatus) predicate.MstStudent {
	vc := v
	return predicate.MstStudent(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldStdStatus), vc))
	})
}

// StdStatusNEQ applies the NEQ predicate on the "std_status" field.
func StdStatusNEQ(v customtypes.StdStatus) predicate.MstStudent {
	vc := v
	return predicate.MstStudent(func(s *sql.Selector) {
		s.Where(sql.NEQ(s.C(FieldStdStatus), vc))
	})
}

// StdStatusIn applies the In predicate on the "std_status" field.
func StdStatusIn(vs ...customtypes.StdStatus) predicate.MstStudent {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func StdStatusNotIn(vs ...customtypes.StdStatus) predicate.MstStudent {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func StdSexEQ(v customtypes.Sex) predicate.MstStudent {
	vc := v
	return predicate.MstStudent(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldStdSex), vc))
	})
}

// StdSexNEQ applies the NEQ predicate on the "std_sex" field.
func StdSexNEQ(v customtypes.Sex) predicate.MstStudent {
	vc := v
	return predicate.MstStudent(func(s *sql.Selector) {
		s.Where(sql.NEQ(s.C(FieldStdSex), vc))
	})
}

// StdSexIn applies the In predicate on the "std_sex" field.
func StdSexIn(vs ...customtypes.Sex) predicate.MstStudent {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func StdSexNotIn(vs ...customtypes.Sex) predicate.MstStudent {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
